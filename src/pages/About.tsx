  ...
  <div className="p-6 rounded-full bg-gradient-to-r from-violet-700/30 to-purple-700/30 border-2 border-violet-700/50">
    <Award className="w-16 h-16 text-violet-700" />
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              From automating GST filings with near-zero errors, to crafting ERP Integrations that adapt seamlessly to a client's growth, we ensure that every solution we provide echoes our motto: <span className="text-violet-400 font-semibold">"Excellence, Always."</span>
            </p>
          </div>
        </div>
      </section>
