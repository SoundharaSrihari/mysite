          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-2 border-violet-400 text-violet-400 hover:text-white hover:bg-violet-500/10 px-8 py-6 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-violet-500/25"
              >
