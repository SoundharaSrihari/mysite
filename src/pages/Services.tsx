...
const Services = () => {
  const services = [
    {
      icon: <Settings className="w-12 h-12 text-violet-400" />,
      title: "ERP Add-ons",
            ...
            {services.map((service, index) => (
              <div key={index} className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-12`}>
                <div className="flex-1">
                  <Card className="bg-gradient-to-b from-violet-950/20 to-black border-violet-500/30 hover:border-violet-400/50 transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-violet-500/20">
                    ...
                    <CardContent className="pt-0">
                      ...
                      <div className="space-y-3">
                        <h4 className="text-violet-400 font-semibold text-lg mb-4">✨ Key Highlights:</h4>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-4">
              {whyChooseUs.map((reason, index) => (
                <div key={index} className="flex items-center space-x-4 p-4 rounded-lg bg-violet-500/10 border border-violet-500/20 hover:bg-violet-500/15 hover:border-violet-400/30 transition-all duration-300">
